...
/// <param name="_tri">三角形(結果出力用)</param>
void ComputeTriangle(const Vector3& _p0, const Vector3& _p1, const Vector3& _p2, Triangle* _tri)
{
	_tri->P0 = _p0;
	_tri->P1 = _p1;
	_tri->P2 = _p2;
...
/// <param name="pos">最近接点(入力)</param>
void ClosestPtPoint2Triangle(const Vector3& _point, const Triangle& _tri, Vector3* pos)
{
	//pointがP0の外側の頂点領域の中にあるかチェック
	Vector3 P0_P1 = _tri.P1 - _tri.P0;
...
/// <param name="_tri">三角</param>
/// <param name="_inter">交点座標</param>
/// <returns></returns>
